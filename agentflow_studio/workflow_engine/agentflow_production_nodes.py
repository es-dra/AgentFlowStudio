...
from agentflow_studio.production.io import (
    load_creative_brief,
...
from agentflow_studio.production.report import render_production_report
from agentflow_studio.production.sop import (
...
def _resolve_creative_brief(step: WorkflowStepDefinition, context: WorkflowContext) -> object:
    ...
    if str(brief_ref) == "creative_brief" and context.inputs.get("artifact_type") == "creative_brief":
        from agentflow_studio.production.schemas import CreativeBrief
...
def register_agentflow_production_nodes(registry: NodeRegistry) -> None:
    registry.register("agentflow_production_load_creative_brief", load_creative_brief_node)
    registry.register("agentflow_production_build_story_bible", build_story_bible_node)
    registry.register("agentflow_production_build_episode_outline", build_episode_outline_node)
    registry.register("agentflow_production_build_scene_plan", build_scene_plan_node)
    registry.register("agentflow_production_build_shot_plan", build_shot_plan_node)
    registry.register("agentflow_production_build_prompt_pack", build_prompt_pack_node)
    registry.register("agentflow_production_build_production_handoff", build_production_handoff_node)
