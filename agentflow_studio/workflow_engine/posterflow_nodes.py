...
from agentflow_studio.production.posterflow.report import render_poster_preview, render_poster_report
from agentflow_studio.production.posterflow.context_runtime import build_context_assembly_trace, build_context_bundle
from agentflow_studio.production.posterflow.sop import (
...
from agentflow_studio.production.posterflow.two_round import (
...
def load_poster_brief_node(step: WorkflowStepDefinition, context: WorkflowContext) -> list[str]:
    ...
    if str(brief_ref) == "poster_brief" and context.inputs.get("artifact_type") == "poster_brief":
        from agentflow_studio.production.posterflow.schemas import PosterBrief
