...
def review_run(run_dir: str | Path) -> dict[str, Any]:
    ...
    if run_manifest and run_manifest.get("quality_profile") == AGENTFLOW_PRODUCTION_HANDOFF_PROFILE:
        sections.append(build_agentflow_production_review_section(root))
