...
- Latest acceptance-first-screen cleanup is covered by the current `codex/afs-landing-prep-web-plan-001` Workbench acceptance-prep commits; the latest browser smoke evidence is `proj_browser_vertical_1781030077`.
