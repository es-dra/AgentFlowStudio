# NarratoCut v0.1.0 Delivery Checklist

NarratoCut `v0.1.0` is the first deliverable distribution-side module of
...
- README and architecture docs state that NarratoCut is a distribution-side
...
- NarratoStudio production-side workflow.
