...
SOURCE_CONTRACTS = (
    ...
    },
    {
        ...
        "issue": "global optimization path still contains the canned template headings rejected by Owner",
        "path": "apps/studio/src/agent-chat-lifecycle.js",
        "must_include": ("不会用本地固定模板冒充专业修订", "revise_selected_node"),
...
const runtime = {
  previewEmbeddedCreativeAction: async (payload) => ({
    ...
    provider_lineage: {
      ...
      structured_output_contract_id: 'afs.runtime.embedded_creative_action.v0.1',
