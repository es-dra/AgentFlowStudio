...
2026-06-01: Loulan API workbench accepts optional context bundle projections from explicit human decisions and blocks fallback when supplied projections are not ready; the real no-call context probe confirms 47 pending decisions, the decision review pack groups them as 5 shots plus 42 assets, the Web workbench renders that review layer from selected files, and the decision worksheet exports empty manual-fill rows without approval; see `docs/handoff/AFS-LOULAN-API-CONTEXT-001.md`, `docs/handoff/AFS-LOULAN-CONTEXT-PROBE-001.md`, `docs/handoff/AFS-LOULAN-DECISION-REVIEW-001.md`, `docs/handoff/AFS-LOULAN-WEB-DECISION-REVIEW-001.md`, and `docs/handoff/AFS-LOULAN-DECISION-WORKSHEET-001.md`.
