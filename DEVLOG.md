...
2026-06-01: Loulan API workbench now accepts optional context bundle projections from explicit human decisions and blocks fallback when supplied projections are not ready; real Loulan no-call context probe confirms 47 pending decisions, the new decision review pack groups them as 5 shots plus 42 assets before approval, and the Web workbench renders that review layer from selected files; see `docs/handoff/AFS-LOULAN-API-CONTEXT-001.md`, `docs/handoff/AFS-LOULAN-CONTEXT-PROBE-001.md`, `docs/handoff/AFS-LOULAN-DECISION-REVIEW-001.md`, and `docs/handoff/AFS-LOULAN-WEB-DECISION-REVIEW-001.md`.
