...
2026-06-01: Loulan memory pilot package, API workbench dry-run, and B01 human review pack contracts, CLIs, Web projections, examples, tracker rows, task briefs, and handoffs added; see `docs/handoff/AFS-LOULAN-PILOT-001.md`, `docs/handoff/AFS-LOULAN-API-WORKBENCH-001.md`, and `docs/handoff/AFS-LOULAN-HUMAN-REVIEW-001.md`.
