...
REVIEW_EXAMPLE = Path("examples/agentflow/agentflow_production_asset_feedback_review.example.json")
VALIDATION_EXAMPLE = Path("examples/agentflow/agentflow_production_asset_feedback_review_validation.example.json")
GATE_EXAMPLE = Path("examples/agentflow/agentflow_production_asset_feedback_review_gate.example.json")
PLAN_EXAMPLE = Path("examples/agentflow/agentflow_production_asset_reuse_dry_run_plan.example.json")


def test_agentflow_production_asset_reuse_review_surface_accepts_ready_chain() -> None:
    ...
    chain_review = review_agentflow_production_asset_reuse_dry_run_chain(
        review=review,
    ...
    assert chain_review["artifact_type"] == "agentflow_production_asset_reuse_review"
    assert chain_review["review_scope"] == "agentflow_production_asset_reuse_dry_run_chain"
...
def test_agentflow_production_asset_reuse_review_surface_blocks_failed_gate() -> None:
    gate = _json(GATE_EXAMPLE)
...
def test_agentflow_production_asset_reuse_review_surface_rejects_mismatched_chain() -> None:
    plan = _json(PLAN_EXAMPLE)
...
def test_agentflow_production_asset_reuse_review_surface_rejects_runtime_or_memory_claims() -> None:
    validation = _json(VALIDATION_EXAMPLE)
