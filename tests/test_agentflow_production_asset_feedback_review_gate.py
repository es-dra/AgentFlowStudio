...
from agentflow.harness.agentflow_production_review import gate_agentflow_production_asset_feedback_review


VALIDATION_EXAMPLE = Path("examples/agentflow/agentflow_production_asset_feedback_review_validation.example.json")


def test_agentflow_production_asset_feedback_review_gate_passes_valid_review_validation() -> None:
    ...
    assert gate["artifact_type"] == "agentflow_production_asset_feedback_review_gate"
    assert gate["gate_scope"] == "agentflow_production_asset_feedback_review"
    ...
    assert gate["source_validation_artifact_type"] == "agentflow_production_asset_feedback_review_validation"
...
def test_agentflow_production_asset_feedback_review_gate_blocks_failed_review_validation() -> None:
    validation = _validation_example()
...
def test_agentflow_production_asset_feedback_review_gate_rejects_runtime_or_write_claims() -> None:
    validation = _validation_example()
