...
def _record_context_overlay(client: TestClient, project_id: str) -> dict:
    feedback = client.post(
        ...
        json={
            ...
            "feedback": {
                ...
                "drift_notes": "Carry this reviewed note only as safe local context evidence.",
            },
        },
    )
    ...
    overlay = client.post(
        ...
        json={
            ...
            "overlay_intent": "Use this reviewed feedback as safe context evidence for the next local pass.",
