...
| 11 | Rerun true reference-backed Path 3 I2I live smoke | AFS-BROWSER-ACCEPTANCE-DRILL-20260615 | P1 | Before human acceptance closeout | 2026-06-15 by Codex | Requires explicit approval for one extra MiniMax image call. Upload or select a reference image in Browser, submit once, and require `reference_image_count > 0` in the safe manifest. |
| 12 | Harden I2I optimizer explicit edit preservation | AFS-BROWSER-ACCEPTANCE-DRILL-20260615 | P1 | Before the next I2I live retry | 2026-06-15 by Codex | Browser drill found the I2I optimizer could adopt reference-preserving tone while contradicting requested background/clothing edits. Add a regression before relying on optimized I2I text for the next live call. |
