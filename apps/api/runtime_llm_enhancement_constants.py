...
PROVIDER_ERROR_PHRASES = (
    "unable to read `request.json`",
    "unable to read request.json",
    "unable to read `prompt.md`",
    "unable to read prompt.md",
    "unable to read the files",
    "unable to read files",
    "i'm unable to read the files",
    "i’m unable to read the files",
    "i am unable to read the files",
    "can't access the requested local files",
    "cannot access the requested local files",
    "can’t access the requested local files",
    "i can't access the requested local files",
    "i cannot access the requested local files",
    "i can’t access the requested local files",
    "can't access local files",
    "cannot access local files",
    "can’t access local files",
    "requested local files",
    "local files in this session",
    "local command sandbox is failing",
    "sandbox is failing before any command runs",
