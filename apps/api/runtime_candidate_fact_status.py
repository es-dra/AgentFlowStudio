"""Candidate Fact Status Model — production module.

Promoted from docs/internal-notes/draft_candidate_fact_status_model_20260802.py.
...
3. Status must distinguish exactly these five:
     extracted_from_text / model_inferred / missing / conflicting / human_confirmed
...
5. Only deterministic validation OR human confirmation may produce an
   AuthoritativeScriptFact (Production Graph wiring is a later step).
"""
...
class CandidateFact(BaseModel):
    """One candidate understanding claim for a supported script entity field.
