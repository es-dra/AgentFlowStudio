...
from apps.cli.adaptive_canvas_commands import (
    real_anime_4shot_agent_script_seed_command,
    real_anime_4shot_paid_v1_command,
)
...
def register_product_commands(app: typer.Typer) -> None:
    ...
    app.command(name="real-anime-4shot-agent-script-seed")(real_anime_4shot_agent_script_seed_command)
