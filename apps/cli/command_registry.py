...
def register_product_commands(app: typer.Typer) -> None:
    ...
    app.command(name="production-memory-loop-record-asset-feedback")(
        production_memory_loop_record_asset_feedback_command
    )
    ...
    app.command(name="production-memory-loop-review-acceptance-feedback-candidate")(
        production_memory_loop_review_acceptance_feedback_candidate_command
    )
    app.command(name="production-memory-loop-run-acceptance-feedback-candidate-reviewed-no-provider")(
        production_memory_loop_run_acceptance_feedback_candidate_reviewed_no_provider_command
    )
    app.command(name="production-memory-loop-draft-operator-feedback-candidate")(
        production_memory_loop_draft_operator_feedback_candidate_command
    )
    app.command(name="production-memory-loop-review-operator-feedback-candidate")(
        production_memory_loop_review_operator_feedback_candidate_command
    )
    app.command(name="production-memory-loop-run-operator-feedback-candidate-reviewed-no-provider")(
        production_memory_loop_run_operator_feedback_candidate_reviewed_no_provider_command
    )
    ...
    app.command(name="production-memory-loop-draft-next-pass-result-no-provider")(
        production_memory_loop_draft_next_pass_result_no_provider_command
    )
    ...
    app.command(name="production-memory-loop-record-next-operator-action-result")(
        production_memory_loop_record_next_operator_action_result_command
    )
