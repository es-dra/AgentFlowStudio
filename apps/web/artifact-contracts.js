import { artifactAliasesFromRegistry, artifactSourceRoleFor } from "./artifact-registry.js?v=m4-memory-canvas-tools";
...
export function sourceRoleFor(type, fileName) {
  const registryRole = artifactSourceRoleFor(type);
