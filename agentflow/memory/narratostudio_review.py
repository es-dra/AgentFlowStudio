...
from agentflow.memory.narratostudio_assets import (
    build_narratostudio_asset_memory_contract_set,
    validate_narratostudio_asset_feedback_sources,
)
...
def review_narratostudio_asset_feedback_loop(
    *,
    ...
    """Compose NarratoStudio source and AgentFlow asset-memory validations."""
    source_validation = validate_narratostudio_asset_feedback_sources(
    ...
    contract_set = build_narratostudio_asset_memory_contract_set(
        production_handoff=production_handoff,
        memory_candidates=memory_candidates,
        feedback_signal_log=feedback_signal_log,
        cost_quality_trace=cost_quality_trace,
...
def _review_result(
    *,
    ...
    return {
        ...
        "artifact_type": "agentflow_narratostudio_asset_feedback_review",
        "validation_scope": "narratostudio_asset_feedback_loop",
...
__all__ = (
    "NOT_RUN",
    "SCHEMA_VERSION",
    "review_narratostudio_asset_feedback_loop",
)
