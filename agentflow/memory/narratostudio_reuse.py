...
def plan_narratostudio_asset_reuse_dry_run(
    *,
    ...
    target_task = source_decision.get("target_task") or "narratostudio_brief_to_production_handoff"
    ...
    return {
        ...
        "artifact_type": "agentflow_narratostudio_asset_reuse_dry_run_plan",
        "plan_scope": "narratostudio_asset_reuse_dry_run",
...
def _gate_checks(source_gate: dict[str, Any]) -> list[dict[str, str]]:
    return [
        _check(
            "gate_artifact_type",
            source_gate.get("artifact_type") == "agentflow_narratostudio_asset_feedback_review_gate",
...
def _review_input_checks(source_review: dict[str, Any], selected_profile_ids: list[str]) -> list[dict[str, str]]:
    ...
    return [
        _check(
            ...
            source_review.get("artifact_type") == "agentflow_narratostudio_asset_feedback_review",
...
__all__ = (
    ...
    "PLAN_READY_ACTION",
    "SCHEMA_VERSION",
    "plan_narratostudio_asset_reuse_dry_run",
)
