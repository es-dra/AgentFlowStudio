...
def validate_narratostudio_asset_feedback_sources(
    *,
    ...
    """Validate NarratoStudio source payloads before asset-feedback mapping."""
    ...
    checks = [
        _check(
            ...
            "all NarratoStudio source artifacts use schema_version 0.1.0",
        ),
        _check(
    ...
    return {
        ...
        "artifact_type": "agentflow_narratostudio_asset_feedback_source_validation",
        "validation_scope": "narratostudio_asset_feedback_sources",
