...
def audit_agentflow_production_asset_reuse_chain_fixture(chain: dict[str, dict[str, Any]]) -> dict[str, Any]:
    """Audit a fixture-built AgentFlow Production asset-reuse chain without creating a contract artifact."""
    ...
    return {
        "audit_scope": "agentflow_production_asset_reuse_chain_fixture",
...
__all__ = (
    ...
    "EXPECTED_CHAIN_ARTIFACT_TYPES",
    "READY_CHAIN_STATUSES",
    "audit_agentflow_production_asset_reuse_chain_fixture",
)
