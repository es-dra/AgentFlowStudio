...
def review_agentflow_production_asset_reuse_dry_run_chain(
    *,
    review: dict[str, Any],
    ...
    """Review an existing AgentFlow Production asset-reuse dry-run chain without side effects."""
    checks = [
    ...
    return {
        ...
        "artifact_type": "agentflow_production_asset_reuse_review",
        "review_scope": "agentflow_production_asset_reuse_dry_run_chain",
    ...
    *,
    ...
    return [
        ...
        _check(
            ...
            "source validation artifact_type is agentflow_production_asset_feedback_review_validation",
        ),
        _check(
            "gate_artifact_type",
        ...
        _check(
            ...
            "source dry-run plan artifact_type is agentflow_production_asset_reuse_dry_run_plan",
        ),
    ]
...
__all__ = (
    ...
    "FORBIDDEN_ACTIONS",
    "SCHEMA_VERSION",
    "review_agentflow_production_asset_reuse_dry_run_chain",
)
