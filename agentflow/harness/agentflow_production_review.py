...
def validate_agentflow_production_asset_feedback_review(review: dict[str, Any]) -> dict[str, Any]:
    """Validate a AgentFlow Production asset-feedback review artifact without executing work."""
    ...
    checks = [
        ...
        _check(
            ...
            review.get("artifact_type") == "agentflow_production_asset_feedback_review",
            "artifact_type is agentflow_production_asset_feedback_review",
        ),
        _check(
            "validation_scope_review",
            review.get("validation_scope") == "agentflow_production_asset_feedback_loop",
            "validation_scope is agentflow_production_asset_feedback_loop",
        ),
        _check(
            "review_not_runtime",
        ...
        _check(
            ...
            == "agentflow_production_asset_feedback_source_validation",
            "review embeds AgentFlow Production source validation",
        ),
        _check(
    ...
    return {
        ...
        "artifact_type": "agentflow_production_asset_feedback_review_validation",
        "validation_scope": "agentflow_production_asset_feedback_review",
...
def gate_agentflow_production_asset_feedback_review(validation: dict[str, Any]) -> dict[str, Any]:
    """Convert a review validation artifact into a decision-only gate result."""
    checks = [
        _check(
            "validation_artifact_type",
            validation.get("artifact_type") == "agentflow_production_asset_feedback_review_validation",
            "source artifact is a AgentFlow Production asset-feedback review validation",
        ),
        _check(
            "validation_scope",
            validation.get("validation_scope") == "agentflow_production_asset_feedback_review",
            "source validation scope is agentflow_production_asset_feedback_review",
        ),
        _check(
            "validation_passed",
    ...
    return {
        "schema_version": SCHEMA_VERSION,
        "artifact_type": "agentflow_production_asset_feedback_review_gate",
        "gate_scope": "agentflow_production_asset_feedback_review",
        "runtime_status": "not_implemented",
        "does_not_execute": True,
        "writes_long_term_memory": False,
