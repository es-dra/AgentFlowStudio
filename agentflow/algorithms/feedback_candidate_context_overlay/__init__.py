...
def build_feedback_candidate_context_overlay(
    *,
    ...
    return {
        ...
        "target_binding": _safe_payload(promotion_decision.get("target_binding")),
        "scope_policy": _safe_payload(promotion_decision.get("scope_policy")),
        "conflict_summary": _safe_payload(promotion_decision.get("conflict_summary")),
