...
AGENTFLOW_EXAMPLE_PATHS = (
    ...
    Path("examples/agentflow/loulan_promotion_decisions_template.example.json"),
    Path("examples/agentflow/loulan_decision_review_pack.example.json"),
    Path("examples/agentflow/loulan_decision_worksheet.example.json"),
    Path("examples/agentflow/loulan_decision_intake_report.example.json"),
